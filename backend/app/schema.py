...
class AssemblyInfo(BaseModel):
    ...
    custom_primers: Optional[str] = Field(None, description="Whether to use a custom primer file for assembly.")
    ...
    custom_irma_config: Optional[str] = Field(None, description="A custom IRMA config file to use for assembly.")
    custom_qc_settings: Optional[str] = Field(None, description="A custom QC settings file to use for assembly.")
