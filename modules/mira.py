...
def mira_ui(data_root):
    ...
    return ui.row(
        ui.column(3,
            ...
            ui.tags.div(
                class_="sidebar-resizer",
                id="mira-sidebar-resizer",
                role="separator",
                aria_orientation="vertical",
                aria_label="Resize sidebar",
            ),
            ui.tags.br(),
            class_="main-sidebar main-sidebar-resizable", id="mira-sidebar",
        ),
        ui.column(9,
            ui.row(
                ui.column(6,
            ...
            ui.row(
                ui.column(6, 
                    ...
                    class_="sequencing-run-container",
                ),
                ui.column(6, 
                    ui.input_selectize(
                    ...
                    class_="organisms-experiment-types-container",
                ),
