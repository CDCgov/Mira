...
- [~~Mac-AppleChip~~](https://desktop.docker.com/mac/main/arm64/Docker.dmg?utm_source=docker&utm_medium=webreferral&utm_campaign=dd-smartbutton&utm_location=module)
  - **_We recommend using podman-desktop instead of docker desktop for newer Macs with M-series chips_**
    - [Mac-AppleChip Podman Desktop instructions](mac-podman-setup.html)
